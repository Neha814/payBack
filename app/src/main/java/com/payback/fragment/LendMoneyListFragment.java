...
public class LendMoneyListFragment extends Fragment {
    ...
    private AsyncHttpClient lendlist;
   // SharedPreferences sp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_lend_money_list, container, false);
    ...
    private void initUI() {
        lendlist = new AsyncHttpClient();
        lendlist.setTimeout(Constants.connection_timeout);
    ...
    private void Calllendlist() {
        ...
        Log.e("Lend Money List ",params.toString());

        lendlist.post(getActivity(), Constants.LendlistURL, params, new JsonHttpResponseHandler() {
...
//                access_token=&authkey=Auth_MicroMovers2015&user_id=54
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            if (status.equals("1")) {
                ...
                holder.status.setTextColor(getResources().getColor(R.color.colordecline));
            } else {
    ...
    public  void onResume(){
        super.onResume();
        ((MainActivity)getActivity()).setTitle("Lend Money List");
    }
}
